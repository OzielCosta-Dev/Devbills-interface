					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
						<div>
							...
							<p className="text-lg text-white mb-8">
								Uma plataforma simples e eficiente para controlar sua despesas e
								receitas. Organize suas finanças pessoais ou do seu negócio com
								facilidade.
							</p>
						</div>
						<div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x">
							<Button className="text-center px-6 py-3">Começar Agora</Button>
						</div>
					</div>
				</section>

				<section className="py-12 md:py-20 bg-gray-900 rouded-xl">
					<div className="container-app">
						...
						<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
							{features.map((feature) => (
								<div
									key={feature.title}
									className="bg-gray-800 p-6 round-xl hover:shadow-lg "
								>
				...
				<section className="py-12 md:py-20">
					<div className="bg-gray-900 p-8 md:p-12 rounded-xl text-center border border-gray-700">
						...
						<p className="text-white text-opacity-90 max-w-2xl mx-auto mb-8">
							...
							o seu dinheiro. É gratuito e fácil de usar!
						</p>
